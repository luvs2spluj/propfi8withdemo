    ...
    <div className="w-64 bg-white dark:bg-gray-800 shadow-lg border-r border-gray-200 dark:border-gray-700 flex flex-col h-screen">
      <div className="p-6">
        <div className="flex items-center space-x-3">
          ...
          />
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">{organizationName || 'Property Management'}</h1>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 space-y-4 border-t border-gray-200 dark:border-gray-700">
        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
          <div 
            className="flex items-center space-x-3 mb-3 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 rounded-md p-2 -m-2 transition-colors duration-200"
